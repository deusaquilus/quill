...
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-spark" % "2.1.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  ...
  "io.getquill" %% "quill-jdbc" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "2.1.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "2.1.1-SNAPSHOT"
)
```
